...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Atom",
    description: "That good shit",
    url: "https://atom-one-sable.vercel.app",
    images: [
      {
        url: "https://wjucegfkshgallheqlzz.supabase.co/storage/v1/object/public/images/masterpiece.png",
        height: 648,
        width: 1152,
        alt: "Very good",
      },
